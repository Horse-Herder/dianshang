...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="{:url('admin/user/url_updo')}" method="post" >
    <ul>
     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>权限名称：</label>
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" placeholder="" id="user-name" name="url_name" value="<?=$url_one['url_name'] ?>" datatype="*2-16" nullmsg="用户名不能为空"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
      <input type="hidden" name="url_id" value="<?=$url_one['url_id'] ?>" />
     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>权限路径：</label>
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" value="<?=$url_one['url_site'] ?>" placeholder="" id="user-name" name="url_site" datatype="*2-16" nullmsg="用户名不能为空"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
	...
	<li class="clearfix">
		    ...
		    <div class="formControls col-xs-6"> <span class="select-box" style="width:150px;">
		        <select class="select" name="url_parent" size="1">
			          ...
			          <?php foreach ($data as $key => $val): ?>
                        ...
                        <?php if ($val['url_id']==$url_one['url_parent']) {?>
                            selected="selected"
                        <?php } ?>
                     >
      ...
      <div class="col-xs-6">
    <input class="btn button_btn bg-deep-blue " type="submit" value="提交修改">
