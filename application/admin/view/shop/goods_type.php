...
<span class="submenu"><a href="javascript:void(0)" name="{:url('admin/shop/add_goods_type')}" class="btn button_btn bg-deep-blue" title="添加产品"><i class="fa  fa-edit"></i>&nbsp;添加商品分类</a></span>
