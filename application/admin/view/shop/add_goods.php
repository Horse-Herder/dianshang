...
<div class="add_style">
 ...
 <!--   <div class="Add_content col-xs-11">
   ...
   <!--  <li class="clearfix"><label class="label_name col-xs-1">设置规格：&nbsp;&nbsp;</label> 
    ...
    <li class="clearfix">
    <label class="label_name col-xs-1">设置规格：&nbsp;&nbsp;</label>
      <div class="Add_content col-xs-11">  
     
      <table>
      <tr class="att">
      <?php foreach($shuxing as $k=> $val):?>
        <td><?= $val['shuxing_name']?></td>
      <?php foreach($guige as $value):?>
        <?php if($value['shuxing_id']==$val['shuxing_id']){?>
        <td><input type="checkbox" name="<?= $val['name']?>[]" value="<?= $value['guige_name']?>"><?= $value['guige_name']?></input></td>
        <?php }?>
      <?php endforeach;?>
      <?php endforeach;?> 
      ...
      <td><a href="javascript:;" class="add">添加</a></td>
      </table>
    ...
    <li class="clearfix">
      <div class="col-xs-4">
     <label class="label_name col-xs-3">商品品牌：&nbsp;&nbsp;</label> 
...
$(function(){
  ...
  $(".add_img").click(function(){
       var img = $(".span_img").clone();
       img.removeClass("span_img");
       $(".span_img").after(img);
    })
