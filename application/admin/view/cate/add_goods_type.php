...
<div class="margin">
<div class="add_style">
  <form action="{:url('admin/cate/add_goods_type')}" method="post">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>分类名称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="cate_name" type="text"  class="col-xs-4"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>分类描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="cate_desc" type="text" class="col-xs-4"/></div></li>
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>关&nbsp;键&nbsp;字：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="keywords" type="text" class="col-xs-4"/><em class="Prompt"> 请用","分隔关键字</em></div></li>
     <li class="clearfix">
      <div class="col-xs-4">
     <label class="label_name col-xs-3"><i>*</i>是否上架：&nbsp;&nbsp;</label> 
    <div class="Add_content col-xs-9">
    <label><input type="radio" name="is_show" value="0" class="ace" checked="checked"><span class="lbl">是</span></label>
    <label><input type="radio" name="is_show" value="1" class="ace"><span class="lbl">否</span></label>
    </div>   
    </div>
    </li>
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>&nbsp;&nbsp;&nbsp;&nbsp;排序：&nbsp;&nbsp;&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="sort_order" type="text"  class="col-xs-4"/></div></li>
    </li>
      ...
      <select name="parent_id" id="">
          ...
          <?php foreach ($type as $key => $value): ?>
            ...
            <?php foreach ($value['child'] as $k => $v): ?>
                <option value="<?=$v['cate_id'] ?>"> <?php for ($i=0; $i <=$v['level'] ; $i++) { ?>
                 └―
               <?php } ?> <?=$v['cate_name'] ?></option>
            <?php endforeach ; ?>
          <?php endforeach ?>
    </select>
  </div></li>
 ...
 <input type="submit" value="保存并提交"  class="btn button_btn bg-deep-blue" type="button"/>
 <input type="reset" value="取消添加"  class="btn button_btn bg-gray"" type="button"/>
  </div>
 </form>
