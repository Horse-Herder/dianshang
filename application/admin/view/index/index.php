...
<!--左侧-->
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <dl class="nav nav-list" id="menu_list">
     <dt class="shop_index nav_link " ><a href="javascript:void(0)" name="{:url('admin/index/shop_index')}" class="iframeurl" title=""><i class="fa fa-home"></i><span class="menu-text">商城首页</span></a></dt>
  ...
  <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-database"></i><span class="menu-text"> 订单管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
      ...
      <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa  fa-file-photo-o"></i><span class="menu-text"> 广告管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="{:url('admin/Guanggao/show')}" title="广告列表" class="iframeurl"><i class="fa fa-angle-double-right"></i>广告列表</a></li>
    ...
    <dd class="submenu">
     <ul>
       ...
       <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-users"></i><span class="menu-text">管理员管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="{:url('admin/user/access')}" title="角色管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>角色管理</a></li>
       <li class="home"><a href="javascript:void(0)" name="{:url('admin/user/url')}" title="权限管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>权限管理</a></li>
       <li class="home"><a href="javascript:void(0)" name="{:url('admin/user/user')}" title="管理员管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>管理员管理</a></li>
       <li class="home"><a href="javascript:void(0)" name="{:url('admin/user/user_access')}" title="个人信息" class="iframeurl"><i class="fa fa-angle-double-right"></i>个人信息</a></li>
       </ul>
      </dd>
       <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-wrench"></i><span class="menu-text">界面工具</span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
...
<!--内容-->
  <div class="Sellerber_content" id="contents">
    <div class="breadcrumbs" id="breadcrumbs">
	  ...
	  <ul class="breadcrumb clearfix" id="min_title_list">
        <li class="active home"><span title="我的桌面" data-href="{:url('admin/index/shop_index')}"><i class="fa fa-home home-icon"></i>首页</span></li>
      </ul>
      </div>
  ...
  <div class="show_iframe" id="show_iframe">
       <iframe scrolling="yes" class="simei_iframe" frameborder="0" src="{:url('admin/index/shop_index')}" name="iframepage" data-href="{:url('admin/index/shop_index')}"></iframe>
       </div>
      </div>
  </div>
<!--底部-->
