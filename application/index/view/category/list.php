        ...
        <div class="l_list">
            ...
            <div class="list_c">
                <ul class="cate_list">
                	...
                	<li>
                    	<div class="img"><a href="{:url('show/product',['goods_id'=>$vo.goods_id])}"><img src="{$vo['goods_img']}" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span>{$vo.market_price}</span></font> &nbsp; 26R
                        </div>
                        <div class="name"><a href="#">{$vo.shop_price}</a></div>
                        <div class="carbg">
