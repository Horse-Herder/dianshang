...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            ...
            <?php }else{ ?>
                <span class="fl"><span style="color: red"><?php echo $user_name; ?></span>&nbsp;|&nbsp;<a href="{:url('login/out')}">退出</a>&nbsp;|</span>
            <?php } ?>
        	<span class="ss">
            	<div class="ss_list">
...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="Index.html"><img src="__PUBLIC__/static/index/images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
   		...
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="{:url('Member/address')}" class="now">收货地址</a></li>
                    <li><a href="#">跟踪订单</a></li>
                </ul>
            </div>
            <div class="left_m">
                ...
                <ul>
                	<li><a href="{:url('Member/user')}">用户信息</a></li>
                    <li><a href="{:url('Member/collect')}">我的收藏</a></li>
                </ul>
            </div>
            <div class="left_m">
            	<div class="left_m_t t_bg3">账户中心</div>
                <ul>
                	<li><a href="{:url('Member/safe')}">账户安全</a></li>
                    <li><a href="{:url('Member/money')}">资金管理</a></li>
                </ul>
            </div>
        </div>